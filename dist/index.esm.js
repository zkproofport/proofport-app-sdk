...
async function generateQRCodeToCanvas(canvas, request, options = {}, scheme = DEFAULT_SCHEME) {
    ...
    const mergedOptions = { ...DEFAULT_QR_OPTIONS, ...options };
    await browser.toCanvas(canvas, url, {
        width: mergedOptions.width,
        errorCorrectionLevel: mergedOptions.errorCorrectionLevel,
        margin: mergedOptions.margin,
        color: {
...
export { CIRCUIT_METADATA, COINBASE_ATTESTATION_PUBLIC_INPUT_LAYOUT, COINBASE_COUNTRY_PUBLIC_INPUT_LAYOUT, DEEP_LINK_HOSTS, DEFAULT_REQUEST_EXPIRY_MS, DEFAULT_SCHEME, MAX_QR_DATA_SIZE, NULLIFIER_REGISTRY_ABI, ProofPortSDK, RPC_ENDPOINTS, VERIFIER_ABI, buildCallbackUrl, buildProofRequestUrl, decodeData, ProofPortSDK as default, encodeData, estimateQRDataSize, extractNullifierFromPublicInputs, extractScopeFromPublicInputs, generateQRCodeDataUrl, generateQRCodeSVG, generateQRCodeToCanvas, generateRequestId, getDefaultProvider, getVerifierAddress, getVerifierChainId, getVerifierContract, isProofPortDeepLink, parseDeepLink, parseProofForOnChain, parseProofRequestUrl, parseProofResponseUrl, validateProofRequest, verifyProofOnChain };
